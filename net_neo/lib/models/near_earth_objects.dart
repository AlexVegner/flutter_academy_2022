...
class NearNarthObjects {
  Map<String, List<Neo>> neos;

  NearNarthObjects({
    required this.neos,
  });

  factory NearNarthObjects.fromNasaJson(Map<String, dynamic> json) {
    final nearEarthObjects = json['near_earth_objects'] as Map<String, dynamic>;
    final neos = nearEarthObjects.map((key, value) {
      final list = (value as List<dynamic>)
          .map<Neo>((e) => Neo.fromNasaJson(e))
          .toList();
      return MapEntry(key, list);
    });

    return NearNarthObjects(neos: neos);
  }
...
void testNearNarthObjects() {
  final json = jsonDecode(_testJson);
  final nearNarthObjects = NearNarthObjects.fromNasaJson(json);
  final jsonNeo = nearNarthObjects.toJson();
  ...
  "near_earth_objects": {
    "2015-09-08": [
      ...
      },
      {
        ...
        "estimated_diameter": {
          "kilometers": {
            "estimated_diameter_min": 0.2101623793,
            "estimated_diameter_max": 0.4699373665
          },
          "meters": {
            "estimated_diameter_min": 210.1623793224,
            "estimated_diameter_max": 469.9373664779
          },
          "miles": {
            "estimated_diameter_min": 0.1305888078,
            "estimated_diameter_max": 0.2920054513
          },
          "feet": {
            "estimated_diameter_min": 689.5091405759,
            "estimated_diameter_max": 1541.7893094353
          }
        },
        "is_potentially_hazardous_asteroid": false,
        "close_approach_data": [
          {
            ...
            "relative_velocity": {
              "kilometers_per_second": "16.9572901605",
              "kilometers_per_hour": "61046.2445778734",
              "miles_per_hour": "37931.7623600681"
            },
            "miss_distance": {
              "astronomical": "0.2804752334",
              "lunar": "109.1048657926",
              "kilometers": "41958497.504392858",
              "miles": "26071801.3837351204"
            },
            "orbiting_body": "Earth"
          }
        ],
